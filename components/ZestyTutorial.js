    ...
    <Container>
      <Box align="center" paddingY={3}>
        <Typography align="center" component="p">
          Welcome to the Zesty.io Next.js starter! Learn more from the project
          read me{' '}
          <a href="https://github.com/zesty-io/nextjs-starter" target="_blank">
      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2} paddingY={3}>
            ...
            <Card sx={{}}>
              ...
              <CardContent style={{ marginBottom: 0, paddingBottom: 0 }}>
                ...
                <Typography variant="body1">
                  Zesty.io is a structured cloud CMS geared for web. When
                  integrated to Next.js, Zesty will dynamically load content to
                  components with writing a fetch request or calling additional
                  functions. It does this by mapping zesty content model names{' '}
                  <i>(you create)</i> to components in the project directory{' '}
                  <Chip label="/views/zesty/" />
                </Typography>
                <Typography gutterBottom variant="body1">
                  This starter project installs with a <Chip label="Homepage" />{' '}
                  content model, edit that component from{' '}
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  <Typography variant="body2">
                    No. <Chip label="npm run sync" /> only needs to run after
                    new content models are created. New content items of
                    existing content models will dynamically load and render. In
                    fact, The only time sync needs to run it is when a new
                    content model is created and the code base is not aware of
                    it (no matching file in <Chip label="views/zesty/" />
                    ). If the code base already knows about a content model and
                    has an associated view file with it any new content will
                    automatically resolve on the server or your local.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                >
                  <Typography>
                    How is published (production) verse draft (stage) content
                    loaded?
                  </Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography variant="body2">
                    Each Zesty Instance lanches with two domains, one for
                    published content, and another for stage or draft content.
                    Your production url is{' '}
                    <a href={prodURL} target="_blank">
                      {prodURL}
                    </a>
                    . Your stage url is{' '}
                    <a href={stageURL} target="_blank">
                      {stageURL}
                    </a>
                    .
                  </Typography>
          ...
          <Grid item xs={4}>
            <Card sx={{}}>
              <CardActionArea
                onClick={() => handleClick('https://chat.zesty.io')}
              >
                <CardMedia
                  component="img"
                  height="140"
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Catch livestream coding sessions and developer guides on our
                    youtube channel. Subcribe to{' '}
                    <a target="_blank" href="https://www.youtube.com/zesty-io">
                      www.youtube.com/zesty-io
                    </a>
                  </Typography>
                </CardContent>
              </CardActionArea>
